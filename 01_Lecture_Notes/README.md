...
| 笔记 | 讲义 | 主题 |
|---|---|---|
| `wk01_计算化学概览与HPC入门.md` | `slides/CM5235_Lecture_01.pdf`（旧名 wk01_intro_slides.pdf） | 课程结构、领域概览、计算机/集群解剖、HPC 上手任务 |
...
第 5、6 讲只有讲义原件：`slides/CM5235_Lecture_05.pdf`（DFT）、`slides/CM5235_Lecture_06.pdf`（波函数分析、相对论、溶剂化），
对应的逐页解析在 `../07_Exam_Review/`。
...
- wk02 / wk03 / wk04 的每个块级公式下面都加了一行 `*读法：…*` 中文解释，**不渲染也能看懂**
